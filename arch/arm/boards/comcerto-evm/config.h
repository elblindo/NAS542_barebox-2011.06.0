...
#define EMAC0_PHY_ADDR	4	// 001
#define EMAC1_PHY_ADDR	6	// 010
...
#define COMCERTO_NAND_FLASH_SIZE	(256UL * 1024UL * 1024UL)   // alltek   256MB

/*SPI NOR Flash CS:0*/
//#define SPI_FLASH_SIZE  (16 * 1024 * 1024) /* 16 MB */
#define SPI_FLASH_SIZE  (1 * 1024 * 1024) /* 1 MB */
